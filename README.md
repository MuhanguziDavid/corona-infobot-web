# Corona Virus Infobot Web

A bot which provides information about COVID-19
...
- Clone this Repo with `$ git clone https://github.com/MuhanguziDavid/corona-infobot-web.git`
